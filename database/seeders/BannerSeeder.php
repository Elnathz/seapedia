    ...
    public function run(): void
    {
        ...
        $banners = [
            ...
            [
                ...
                'cta_url' => '/catalog',
                'placement' => 'main',
                'image_path' => 'images/banner/utama/promohematbanner.jpg',
                'sort_order' => 0,
                'is_active' => true,
            ],
            [
                ...
                'placement' => 'main',
                'image_path' => 'images/banner/utama/sepeda-polygon-indonesia-bisa.jpg',
                'sort_order' => 1,
                'is_active' => true,
            ],
            ...
            [
                ...
                'placement' => 'side_top',
                'image_path' => 'images/banner/atas/Panasonic-lumix-f280D-digital-camera.jpg',
                'sort_order' => 0,
                'is_active' => true,
            ],
            [
                ...
                'placement' => 'side_top',
                'image_path' => 'images/banner/atas/Top Gear ZD 4 inci Infinite Action Figure S Iron Man Mark 85 rp 59,900.jpg',
                'sort_order' => 1,
                'is_active' => true,
            ],
            ...
            [
                ...
                'image_path' => 'images/banner/bawah/Apex Pro TKL Wireless Gen 3 rp 3,299,000.jpg',
                'sort_order' => 0,
                'is_active' => true,
            ],
        ];
