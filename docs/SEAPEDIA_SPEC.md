# SEAPEDIA — Technical Challenge (COMPFEST 18 Software Engineering Academy)
...
**The core challenge is worth 100 points.** Additional bonus points may be awarded for interface quality and deployment.
...
### 1A. Create the Public Marketplace Interface (4 pts)
...
### 1B. Implement Basic Authentication and Role Awareness (8 pts)
...
### 1C. Add Public Application Reviews (4 pts)
...
### 1D. Build Reusable UI Foundations (4 pts)
...
### 2A. Create Seller Store Management (5 pts)
...
### 2B. Implement Product Management for Sellers (6 pts)
...
### 2C. Connect Products to the Public Catalog (4 pts)
...
### 3A. Build Buyer Wallet and Address Management (5 pts)
...
### 3B. Implement Cart Management (5 pts)
...
### 3C. Create Checkout and Basic Orders (10 pts)
...
### 4A. Implement Voucher and Promo Discounts (6 pts)
...
### 4B. Allow Sellers to Process Orders (4 pts)
...
### 4C. Add Buyer and Seller Reports (5 pts)
...
### 5A. Create Delivery Jobs for Drivers (4 pts)
...
### 5B. Implement Take Job and Delivery Completion (4 pts)
...
### 5C. Show Driver Earnings and Job History (2 pts)
...
### 6A. Build Admin Monitoring Dashboard (3 pts)
...
### 6B. Complete Voucher and Promo Management UI (2 pts)
...
### 6C. Implement Overdue Auto Return or Refund (5 pts)
...
### 7A. Secure Inputs, Queries, and Public Comments (4 pts)
...
### 7B. Harden Session and Role-Based Access Control (3 pts)
...
### 7C. Prepare Final Documentation and Demo Data (3 pts)
...
- **Deployment** (15 pts): You have the freedom to choose any deployment method you prefer. Make sure the deployed application can be accessed and tested by the evaluator.
