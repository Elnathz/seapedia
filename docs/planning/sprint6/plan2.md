...
3. **New "Bright Sea" palette** (Parangtritis-sea turquoise), two-tier for contrast:| Role                   | Hex                       | HSL             | Usage                                                  |
   | ---------------------- | ------------------------- | --------------- | ------------------------------------------------------ |
...
- **R0 · Tokens + logo + dark-mode removal** (the migration above) — `feat(ui): adopt bright-sea light-only palette and new logo`.
