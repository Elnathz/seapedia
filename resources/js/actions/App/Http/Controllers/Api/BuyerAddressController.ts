...
/**
* @see \App\Http\Controllers\Api\BuyerAddressController::index
* @see app/Http/Controllers/Api/BuyerAddressController.php:25
* @route '/api/v1/buyer/addresses'
*/
...
/**
* @see \App\Http\Controllers\Api\BuyerAddressController::store
* @see app/Http/Controllers/Api/BuyerAddressController.php:39
* @route '/api/v1/buyer/addresses'
*/
...
/**
* @see \App\Http\Controllers\Api\BuyerAddressController::update
* @see app/Http/Controllers/Api/BuyerAddressController.php:56
* @route '/api/v1/buyer/addresses/{address}'
*/
...
update.definition = {
    methods: ["put"],
    url: '/api/v1/buyer/addresses/{address}',
...
/**
* @see \App\Http\Controllers\Api\BuyerAddressController::setDefault
* @see app/Http/Controllers/Api/BuyerAddressController.php:70
* @route '/api/v1/buyer/addresses/{address}/default'
*/
...
setDefault.definition = {
    methods: ["patch"],
    url: '/api/v1/buyer/addresses/{address}/default',
...
/**
* @see \App\Http\Controllers\Api\BuyerAddressController::destroy
* @see app/Http/Controllers/Api/BuyerAddressController.php:84
* @route '/api/v1/buyer/addresses/{address}'
*/
...
const BuyerAddressController = { index, store, update, setDefault, destroy }
