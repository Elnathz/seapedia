...
/**
* @see \App\Http\Controllers\Web\DriverJobController::index
* @see app/Http/Controllers/Web/DriverJobController.php:22
* @route '/driver/jobs'
*/
...
* @see app/Http/Controllers/Web/DriverJobController.php:29
...
* @see app/Http/Controllers/Web/DriverJobController.php:48
...
* @see app/Http/Controllers/Web/DriverJobController.php:65
...
complete.definition = {
    methods: ["post"],
    url: '/driver/jobs/{delivery}/complete',
} satisfies RouteDefinition<["post"]>
...
const DriverJobController = { index, show, take, complete }

export default DriverJobController