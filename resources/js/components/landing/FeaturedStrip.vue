...
<template>
    <section class="border-b border-border bg-white py-12 sm:py-16">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mb-8 flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-muted-foreground">
                        Produk terbaru dari toko-toko aktif
                    </p>
                </div>
                <Button
                    as-child
            ...
            >
                ...
                <p class="text-sm text-muted-foreground">
                    Belum ada produk. Jadilah yang pertama berjualan!
                </p>
            </div>
            ...
            >
                <Link
                    ...
                    class="group flex w-[200px] shrink-0 flex-col overflow-hidden rounded-2xl border border-border/50 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:shadow-lg lg:w-auto"
                >
                    <div
                    ...
                    >
                        ...
                        <div
                            ...
                            class="absolute top-2 right-2 rounded-full bg-rose-500 px-2 py-0.5 text-xs font-bold text-white shadow-sm"
                        >
