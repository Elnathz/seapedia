export default {
    ...
    product: {
        ...
        categoryParentPlaceholder: 'Pilih kategori',
        categoryChildPlaceholder: 'Pilih sub-kategori',
        categoryHelp: 'Pilih kategori induk, lalu sub-kategorinya.',
        priceLabel: 'Harga (Rp)',
        stockLabel: 'Stok',
    ...
    checkout: {
        ...
        browseDiscounts: 'Lihat Promo & Voucher',
        promosTab: 'Promo',
        vouchersTab: 'Voucher',
        noPromos: 'Belum ada promo yang tersedia.',
        noVouchers: 'Belum ada voucher yang tersedia.',
        discountPercentOff: 'Diskon {value}%',
        discountAmountOff: 'Potongan {amount}',
        discountMaxCap: 'maks {amount}',
        discountSave: 'Hemat {amount}',
        discountMin: 'Min. belanja {amount}',
        discountMinUnmet: 'Belum memenuhi minimum belanja',
        voucherLeft: 'Sisa {remaining} dari {total} kupon',
        discountApplied: 'Terpakai',
    ...
    admin: {
        ...
        manageCategoriesTitle: 'Kelola Kategori',
        addPromo: 'Promo Baru',
        addVoucher: 'Voucher Baru',
        addCategory: 'Kategori Baru',
        editCategory: 'Edit Kategori',
        categoryNameLabel: 'Nama kategori',
        categoryParentLabel: 'Kategori induk',
        categoryParentNone: 'Tidak ada (jadikan kategori induk)',
