        ...
        <div class="p-6">
            <div class="mb-6 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-muted-foreground">Total {{ orders.total }} pesanan</p>
                </div>
            </div>

            <div class="mb-4 flex gap-3">
                <Input v-model="search" placeholder="Cari ID pesanan..." class="max-w-xs" />
                ...
                <Table>
                    ...
                    <TableBody>
                        <TableRow v-if="orders.data.length === 0">
                            <TableCell colspan="6" class="py-8 text-center text-muted-foreground">Tidak ada pesanan ditemukan.</TableCell>
                        </TableRow>
                        <TableRow v-for="order in orders.data" :key="order.id">
                            ...
                            <TableCell class="text-xs text-muted-foreground">{{ order.created_at?.slice(0, 10) }}</TableCell>
                        </TableRow>
                    </TableBody>
                </Table>
            </div>
