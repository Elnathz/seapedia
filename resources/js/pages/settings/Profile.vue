...
<template>
    ...
    <div class="mx-auto max-w-3xl space-y-6 px-4 pb-10 sm:px-6">
            ...
            <CardContent>
                ...
                >
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            <Label for="email"> Email <RequiredMark /> </Label>
                            <Input
                                id="email"
                                type="email"
                                name="email"
        ...
        <AddressList
            v-if="auth.activeRole === 'buyer' && addresses !== undefined"
            :addresses="addresses"
        />
        ...
        <Card v-if="auth.activeRole === 'driver' && driverStats">
            ...
            <CardContent>
                <div class="grid gap-4 sm:grid-cols-2">
                    <div
                        class="rounded-xl bg-gradient-to-r from-amber-50 to-amber-100 p-4"
                    >
                        <p class="text-sm text-amber-700">Penghasilan Total</p>
                        <p
                            class="text-2xl font-bold text-amber-600 tabular-nums"
                        >
                            {{ formatIDR(driverStats.total_earnings) }}
                        </p>
                    </div>
                    <div
                        class="rounded-xl bg-gradient-to-r from-emerald-50 to-emerald-100 p-4"
                    >
                        <p class="text-sm text-emerald-700">
                            Pengiriman Selesai
                        </p>
                        <p
                            class="text-2xl font-bold text-emerald-600 tabular-nums"
                        >
        ...
        <Card v-if="!user.is_admin" class="border-destructive/30">
            ...
            <CardContent>
                <p class="mb-4 text-sm text-muted-foreground">
                    Menghapus akun akan permanently menghapus semua data Anda
                    termasuk riwayat pesanan, saldo wallet, dan data toko.
